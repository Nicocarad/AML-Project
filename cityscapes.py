...
class Cityscapes(Dataset):
    def __init__(self, root, mode="train"):
        ...
        self.imgs, img_file_names = process_directory(
            root, mode, "images", "_leftImg8bit.png"
        )
        self.labels, fine_file_names = process_directory(
            root, mode, "gtFine", "_gtFine_labelTrainIds.png"
        )
    ...
    def __getitem__(self, idx):
        ...
        img_path = self.imgs[
            img_name
        ]  # get the path of the image file from the dictionary key: img_name value: path of the image
        label_path = self.labels[
            img_name
        ]  # get the path of the label file from the dictionary key: img_name value: path of the label
